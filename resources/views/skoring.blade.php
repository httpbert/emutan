            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-8 skoring-content-left">
                    <div class="header-skoring">
                        <h1 class="heading-skoring">Cek skor kamu, dapatkan pendanaan pertanian s/d 100 Juta</h1>
                        <p class="description-skoring mb-3">Skoring adalah sebuah penilaian yang dijadikan dasar
                            ...
                            semakin baik nilai skor anda, makan akan semakin besar peluang untuk dapetin pinjaman sampai
                            100 juta.</p>
                    </div>

                    <div class="buttons-header">
                        <a href="#cek-skor" class="btn btn-success skoring-button text-decoration-none text-white fw-bold">
                            Cek Skor dan Dapatkan Pinjaman
                        </a>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 skoring-content-right">
                    <div class="skoring-section-img">
                        <img src="assets/img/skoring/img1.png" alt="gambar hero skoring" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-skoring">
        <div class="container-fluid header">
            <div class="row skoring-content">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 skoring-content-right">
                    <div class="skoring-section-img">
                        <img src="assets/img/skoring/img2.png" alt="gambar hero skoring" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row row-content">
                <div class="col-sm-12 col-md-6 col-lg-6 box-skoring mb-3">
                    <div class="box-description">
                        <h5>Mempercepat proses pengajuan dan pencairan pinjaman.</h5>
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 box-skoring">
                    <div class="box-description">
                        ...
                        <p class="skoring-unggul">
                            Mengatahui Skor Kreditmu dapat memberikan pemahaman yang lebih baik untuk waktu paling tepat
        ...
        <div class="container">
            ...
            <div class="row row-content">
                <div class="col-sm-12 col-md-6 col-lg-4 box-skoring mb-3">
                    <div class="box-card">
                        <img src="assets/img/skoring/image1.png" alt="gambar keuntungan skoring">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 box-skoring mb-3">
                    <div class="box-card">
                        <img src="assets/img/skoring/image2.png" alt="gambar keuntungan skoring">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 box-skoring mb-3">
                    <div class="box-card">
                        <img src="assets/img/skoring/image4.png" alt="gambar keuntungan skoring">
                        <p class="title-card">Partner Yang Terpercaya</p>
                        <p class="skoring-unggul">
                            Credit-rating agency yang telah berdiri sejak 1993. bergerak dibawah pengawasan OJK dan BI
                        </p>
                    </div>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 box-skoring mb-3">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-4 left-content">
                    <div class="skoring-section-img">
                        <img src="assets/img/skoring/img3.png" class="img-fluid" alt="gambar steplogin">
                    </div>
                </div>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-12">
                            <div class="caption d-flex">
                                ...
                                <div class="group-step">
                                    <h6>Login/Daftar</h6>
                                    <p>Login menggunakan akun E-Mutanmu atau daftar akun bisnis jika belum.</p>
                                </div>
                            </div>
                            <div class="caption d-flex">
                            ...
                            <div class="caption d-flex">
                                ...
                                <div class="group-step">
                                    <h6>Dapatkan Skor Pendanaan</h6>
                                    <p>Dapatkan skor kreditmu dan ikuti instruksi untuk mengajukan cicilan di eMutan.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <a href="{{ 'daftar' }}" class="tmb-skoring">Mulai Sekarang</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="grade-container" id="cek-skor">
        <div class=" row">
            <div class="col-12 py-3 grade-header">
                <h1 class="text-black text-center grade-heding">Kenali Skor Pendanaan Anda</h1>
            ...
            <div class="col-12">
                <div class="bg-white rounded">
                    <ul class="nav nav-tabs justify-content-center" style="border: none;">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-decoration-none grade text-black fw-bold" data-bs-toggle="tab"
                                href="#gradeb">Grade B
                                (60%-79%)</a>
                        </li>
                        <li class="nav-item">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-6 col-sm-10 my-4">
                                                <p class="card-text">Kesehatan keuangan bisnismu cukup baik, memungkinkan
                                                    anda lolos
                                                    dalam
                                                    mendapatkan pendanaan dari Emutan.</p>
                                            </div>
                                        </div>
                                    </div>
