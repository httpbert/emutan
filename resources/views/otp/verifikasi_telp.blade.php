    ...
    <div class="otp-container">
        <div class="container d-flex justify-content-center align-items-center">
            <div class="card card-otp py-5 px-5">
                <h5 class="m-0 mb-4">Verifikasi by Telepon</h5>
                <span class="mobile-text">
                    Masukkan kode yang telah dikirimkan melalui nomor telepon yang anda masukkan!
                    <b class="text-primary">+62 89591910320</b>
                </span>
