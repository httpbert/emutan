    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src={{ '../assets/img/pupuk/obat-obatan.png' }} class="d-block w-100" alt="gambar jumbotron pupuk">
            </div>
        </div>
    </div>
                                ...
                                <div id="semua" class="tab-pane fade in active show">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6 col-sm-12 col-6 my-4">
                                            <div class="card card-body-produk p-4">
                                                <img src={{ '../assets/img/pupuk/produk.png' }} alt="">
                                                <h5 class="card-title">Futata</h5>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-sm-12 col-6 my-4">
                                            <div class="card card-body-produk p-4">
                                                <img src={{ '../assets/img/pupuk/produk.png' }} alt="">
                                                <h5 class="card-title">Pancang</h5>
                                                <p class="card-text">Rp. 20,000</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="cabe" class="tab-pane fade">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6 col-sm-12 col-6 my-4">
                                            <div class="card card-body-produk p-4">
                                                <img src={{ '../assets/img/pupuk/produk.png' }} alt="">
                                                <h5 class="card-title">Produk Cabe</h5>
                                                <p class="card-text">Rp. 20,000</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-sm-12 col-6 my-4">
                                ...
                                <div id="padi" class="tab-pane fade">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6 col-sm-12 col-6 my-4">
                                            <div class="card card-body-produk p-4">
                                                <img src={{ '../assets/img/pupuk/produk.png' }} alt="">
                                                <h5 class="card-title">Produk Padi</h5>
                                                <p class="card-text">Rp. 20,000</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-sm-12 col-6 my-4">
                                ...
                                <div id="kelapasawit" class="tab-pane fade">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6 col-sm-12 col-6 my-4">
                                            <div class="card card-body-produk p-4">
                                                <img src={{ '../assets/img/pupuk/produk.png' }} alt="">
                                                <h5 class="card-title">Produk Sawit</h5>
                                                <p class="card-text">Rp. 20,000</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-sm-12 col-6 my-4">
                                ...
                                <div id="kedelai" class="tab-pane fade">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6 col-sm-12 col-6 my-4">
                                            <div class="card card-body-produk p-4">
                                                <img src={{ '../assets/img/pupuk/produk.png' }} alt="">
                                                <h5 class="card-title">Produk Kedelai</h5>
                                                <p class="card-text">Rp. 20,000</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-sm-12 col-6 my-4">
                                ...
                                <div id="jagung" class="tab-pane fade">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6 col-sm-12 col-6 my-4">
                                            <div class="card card-body-produk p-4">
                                                <img src={{ '../assets/img/pupuk/produk.png' }} alt="">
                                                <h5 class="card-title">Produk Jagung</h5>
                                                <p class="card-text">Rp. 20,000</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-sm-12 col-6 my-4">
