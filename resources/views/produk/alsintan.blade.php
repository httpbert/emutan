    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src={{ '../assets/img/pupuk/pupuk-alsintan.png' }} class="d-block w-100" alt="gambar jumbotron pupuk">
            </div>
        </div>
    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3 col-md-6 col-sm-12 col-6 my-4">
                                            <div class="card card-body-produk p-2">
                                                <img src={{ '../assets/img/pupuk/alsintan/alsintan1.png' }} width="155"
                                                    style="display: block; margin: auto">
                                                <h5 class="card-title">Tracktor Tangan</h5>
                                                <p class="card-text fw-bold">Rp. 87.400,000</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-sm-12 col-6 my-4">
                                            <div class="card card-body-produk p-2">
                                                <img src={{ '../assets/img/pupuk/alsintan/alsintan2.png' }} width="155"
                                                    style="display: block; margin: auto">
                                                <h5 class="card-title">Combine</h5>
                                                <p class="card-text fw-bold">Rp. 90.120,000</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-sm-12 col-6 my-4">
                                            <div class="card card-body-produk p-2">
                                                <img src={{ '../assets/img/pupuk/alsintan/alsintan3.png' }} width="150"
                                                    style="display: block; margin: auto">
                                                <h5 class="card-title">Tracktor Roda 4</h5>
                                                <p class="card-text fw-bold">Rp. 125.150,000</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 col-sm-12 col-6 my-4">
                                            <div class="card card-body-produk p-2">
                                                <img src={{ '../assets/img/pupuk/alsintan/alsintan4.png' }} width="255"
                                                    style="display: block; margin: auto">
                                                <h5 class="card-title">Drone Agriculture</h5>
