                                    ...
                                    <div class="col-12">
                                        <div class="tab-content">
                                            ...
                                            <div id="saldodana" class="tab-pane fade in active show">
                                                <div class="card mt-3">
                                                    <div class="row m-2">
                                                        <h6 class="text-center mt-3 mb-3">Lengkapi Identitas Anda
                                                        </h6>
                                                        <p class="text-center" style="font-size: 11px">Sesuai dengan
                                                            ketentuan
                                                            & peraturan
                                                            OJK, Kami membutuhkan identitas pribadi Anda</p>
                                                        <form class="row g-3">
                                                            <div class="form-group regform-caption mb-3">
                                                                <label class="d-flex">NIK
                                                                    <span class="text-danger"> &nbsp; *</span>
                                                                </label>
                                                                <input type="number" placeholder="Masukkan NIK">
                                                            </div>
                                                            <div class="form-group regform-caption mb-3">
                                                                <label class="d-flex">Nama Sesuai KTP
                                                                    <span class="text-danger"> &nbsp; *</span>
                                                                </label>
                                                                <input type="text"
                                                            ...
                                                            <div class="form-group regform-caption mb-3">
                                                                <label class="d-flex">Alamat
                                                                    <span class="text-danger"> &nbsp; *</span>
                                                                </label>
                                                                <input type="text" placeholder="Masukkan alamat">
                                                            </div>
                                                            <div class="form-group regform-caption mb-3">
                                                                <label class="d-flex">Upload Foto KTP
                                                                    <span class="text-danger"> &nbsp; *</span>
                                                                </label>
                                                            ...
                                                            <div class="form-group regform-caption mb-3">
                                                                <label class="d-flex">Upload Foto Selfie
                                                                    <span class="text-danger"> &nbsp; *</span>
                                                                </label>
                                                                <label for="images" class="drop-container">
                                                                    <span class="drop-title">Drop files here</span>
                                                            ...
                                                            <a href="{{ 'akun_bank' }}" class="btn text-white"
                                                                style="background-color: #1a5653;">Continue</a>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
