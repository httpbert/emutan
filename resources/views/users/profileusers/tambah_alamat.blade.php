                                                    ...
                                                    <div class="row m-2">
                                                        ...
                                                        <div class="content-user mt-5">
                                                            <form class="row g-3">
                                                                ...
                                                                <div class="col-6">
                                                                    <img src={{ 'assets/img/icons/img6.png' }}
                                                                        alt=""
                                                        ...
                                                        <form class="row">
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                <input type="number" class="form-control"
                                                                    id="nomorTelp" placeholder="Nomor Telepon">
                                                            </div>

                                                            <div class="col-md-12 mb-3">
                                                                <input type="text" class="form-control"
                                                                    id="inputProvinsi" placeholder="Provinsi">
                                                            </div>
                                                            <div class="col-md-12 mb-3">
                                                                <input type="text" class="form-control"
                                                                    id="inputKabKota" placeholder="Kabupaten/Kota">
                                                            </div>
                                                            <div class="col-md-12 mb-3">
                                                                <input type="number" class="form-control"
                                                                    id="inputKodePos" placeholder="Kode Pos">
                                                            </div>
                                                            <div class="col-md-12 mb-3">
                                                                <textarea class="form-control" name="" id="inputDetail" rows="3" placeholder="Detail Lainnya"></textarea>
                                                            </div>
                                                            <div class="col-12 mt-5">
                                                                ...
                                                                <a href="#"
                                                                    class="float-end me-2 btn btn-primary"
