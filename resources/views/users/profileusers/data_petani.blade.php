            ...
            <div class="col-lg-8 col-md-12 col-12 personal-data">
                <div class="col-12">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="card p-3">
                                <h3 class="text-center mb-3">Data Petani</h3>
                                <form action="">
                                    <div class="form-group mb-3">
                                        <label class="form-label">Luas lahan yang dimiliki berapa?</label>
                                        <input type="number" class="form-control">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label class="form-label">Sebelumnya sudah mendapatkan pendanaan dari mana
                                            saja ?</label>
                                        <input type="text" class="form-control">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label class="form-label">Pengalaman bertani di komoditas sebelumnya sudah
                                            berapa lama?</label>
                                        <input type="text" class="form-control">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label class="form-label">Apa saja kendala yg di hadapi sebelumnya saat
                                            bertani?</label>
                                        <input type="text" class="form-control">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label class="form-label">Sebenarnya petani sudah bergabung di komoditas apa
                                            aja?</label>
                                        <input type="text" class="form-control">
                                    </div>
                                    <div class="form-group mb-3">
                                    ...
                                    <div class="form-group mb-3">
                                        <button type="submit" class="btn btn-primary float-end"
                                            style="background-color:#1a5653; border: #1a5653">Simpan</button>
                                    </div>
                                </form>
                            </div>
                        </div>
